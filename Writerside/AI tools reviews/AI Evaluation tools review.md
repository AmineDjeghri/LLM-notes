...
| **cloud deployment**      | <span style="background:rgba(163, 67, 31, 0.2)">paid</span>      | <span style="background:#d3f8b6">Free</span> (1 user), paid for other | <span style="background:#d3f8b6">Free</span> (2 users with limited features)<br>paid for other licences | paid                                                                   |
| Collaboration             | paid                                                             | paid                                                                  | <span style="background:#d3f8b6">Free</span> (self host) or cloud 2 users<br>paid (cloud)               | paid                                                                   |
...
| - Annotate/Human feedback | <span style="background:#d3f8b6">Free</span>                     | <span style="background:#d3f8b6">Free</span> (1 user, cloud)          | <span style="background:#d3f8b6">Free</span>                                                            | Paid                                                                   |
| - Real time evaluation    | Paid                                                             | <span style="background:#d3f8b6">Free</span> (1 user, cloud)          | <span style="background:#d3f8b6">Free</span>                                                            | Paid                                                                   |
| **Redteaming**            |                                                                  |                                                                       |                                                                                                         |                                                                        |
...
| **Monitoring**            | paid                                                             | <span style="background:#d3f8b6">Free</span> (1 user)                 | <span style="background:#d3f8b6">Free</span>                                                            | Paid                                                                   |
