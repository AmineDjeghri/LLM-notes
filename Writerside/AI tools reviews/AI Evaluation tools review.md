...
- **LLM Evaluation tool and redteaming tool**: 
	- **Review date** : 21/11/2024
    - **Description**: Get your LLM app from prototype to production. LangSmith is an all-in-one developer platform for every step of the LLM-powered application lifecycle, whether you’re building with LangChain or not. Debug, collaborate, test, and monitor your LLM applications.
	    - 
	- FAQ : https://www.promptfoo.dev/docs/faq/
	- **Docs**: [docs](https://www.promptfoo.dev/docs/intro/)
    - **GitHub**: https://github.com/promptfoo/promptfoo
